...
public abstract class Controller implements Observer<ViewMessage> {
     ...
     */
    protected void registerActions(Map<String, Consumer<ViewMessage>> actions){
        //TODO: insert mapping.
    }
    ...
    private void performAction(ViewMessage message){
        ...
        if(action != null)
            ...
            message.getView().showError("Something went wrong: unsupported action");
    }
    ...
    protected void activateToolCard(ViewMessage message) {
        ...
        if (canUseToolCard(selectMessage)) {
            ...
            if(behavior != null)
                ...
                message.getView().showError("Invalid tool card!");

        } else
            message.getView().showError("You can't use this tool card!");
    }
