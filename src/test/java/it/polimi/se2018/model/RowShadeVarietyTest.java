...
/**
 * Unit tests for RowShadeVariety class.
 */
public class RowShadeVarietyTest {
    ...
    public void testMultipleInstantiation() {
        RowShadeVariety firstInstance = RowShadeVariety.getInstance();
        RowShadeVariety secondInstance = RowShadeVariety.getInstance();
    ...
    public void testSimpleScoreCalculation() {
        ...
        int actualScore = RowShadeVariety.getInstance().getScore(grid);
